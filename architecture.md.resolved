...
flowchart TD
    ...
    Price --> Show["Show Options: Most Profitable vs Best for User"]
...
flowchart TD
    ...
    LTL --> Details["Enter Load Details: Weight, Dimensions, Type"]
    FTL --> Details
    
    Details --> Truck["Select Truck Type: Flatbed, Reefer, Tanker"]
...
| **Weather** | OpenWeatherMap / AccuWeather | Weather data, forecasts, alerts |
| **Traffic** | Google Maps Traffic / HERE | Road incidents, traffic data |
